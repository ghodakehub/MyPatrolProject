...
public class Patrol_CalendarTest extends BaseTest {
	...
	public void verifyNotification() {
		...
		Patrol_CalendarPage cal= new Patrol_CalendarPage(driver,test);
		cal.CheckCalendar();
	}
			...
			String testUrl = driver.getCurrentUrl();  
			 Patrol.Utility.ForMultiplemailReceipent.sendEmail(
	            	   driver, new String[]{"ghodake6896@gmail.com"},
	            	    "Patrol- Calendar ",
	            	    "Please check Calendar not working showing error , please find the attached screenshot for details." ,
	            	    screenshot,testUrl
