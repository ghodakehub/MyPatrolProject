...
public class Patrol_ChatTest extends BaseTest {
	...
	public void verifyNotification() {
		...
		Patrol_ChatPage chat= new Patrol_ChatPage(driver,test);
		chat.CheckAI_Chat();
	}
			...
			String testUrl = driver.getCurrentUrl();  
			 Patrol.Utility.ForMultiplemailReceipent.sendEmail(
	            	   driver, new String[]{"ghodake6896@gmail.com"},
	            	    "Patrol- AI-CHAT ",
	            	    "Please check Patrol AI-CHAT not working showing error , please find the attached screenshot for details." ,
	            	    screenshot,testUrl
