...
public class Patro_ReportTest extends BaseTest {
	...
	public void verifyNotification() {
		...
		Patrol_Reports opt= new Patrol_Reports(driver,test);
			...
			String testUrl = driver.getCurrentUrl();  
			 Patrol.Utility.ForMultiplemailReceipent.sendEmail(
	            	   driver, new String[]{"ghodake6896@gmail.com"},
	            	    "Patrol- Reports ",
	            	    "Please check Patrol Reports not working showing error , please find the attached screenshot for details." ,
	            	    screenshot,testUrl
