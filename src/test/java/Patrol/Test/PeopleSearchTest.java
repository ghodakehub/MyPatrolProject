...
public class PeopleSearchTest extends BaseTest{
	...
	public void makeNewMatter() throws InterruptedException {
		...
		PeopleSearch people  = new PeopleSearch(driver,test);
		people.clickOnPeopleViewAll("NTPC_COMAPNY AutomationTest");
