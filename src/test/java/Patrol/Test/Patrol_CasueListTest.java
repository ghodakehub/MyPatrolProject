...
public class Patrol_CasueListTest extends BaseTest {
	...
	public void verifyNotification() {
		...
		Patrol_CauseList cause= new Patrol_CauseList(driver,test);
			...
			String testUrl = driver.getCurrentUrl();  
			 Patrol.Utility.ForMultiplemailReceipent.sendEmail(
	            	   driver, new String[]{"ghodake6896@gmail.com"},
	            	    "Patrol- CauseList ",
	            	    "Please check Patrol CauseList not working showing error , please find the attached screenshot for details." ,
	            	    screenshot,testUrl
