...
public class Patrol_OrderTrack extends BaseTest {
	...
	public void verifyNotification() {
		...
		Patrol_OrderTracker track= new Patrol_OrderTracker(driver,test);
			...
			String testUrl = driver.getCurrentUrl();  
			 Patrol.Utility.ForMultiplemailReceipent.sendEmail(
	            	   driver, new String[]{"ghodake6896@gmail.com"},
	            	    "Patrol- OrderTracker ",
	            	    "Please check Patrol OrderTracker not working showing error , please find the attached screenshot for details." ,
	            	    screenshot,testUrl
