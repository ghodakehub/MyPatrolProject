...
public class Patrol_NotificationTest extends BaseTest {
	...
	public void verifyNotification() {
		...
		Patrol_Notification notify= new Patrol_Notification(driver,test);
			...
			String testUrl = driver.getCurrentUrl();  
			 Patrol.Utility.ForMultiplemailReceipent.sendEmail(
	            	   driver, new String[]{"ghodake6896@gmail.com"},
	            	    "Patrol- Notification ",
	            	    "Please check Notification not working showing error , please find the attached screenshot for details." ,
	            	    screenshot,testUrl
